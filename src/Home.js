...
function App() {
  ...
  const websiteInfo = [
    {
      name: "Amis",
      description:
        `A Mouse Imaging Server (AMIS) hosts mouse imaging data generated by 
        ...
        tissues at extraordinarily high resolution, allowing investigators to 
        generate hypotheses about these under-studied gene products.`,
    ...
    },
    {
      name: "Cartblanche",
      description:
        `Cartblanche is an interface to ZINC-22, containing over 100 billion 2D
    ...
    },
    {
      ...
      description:
        `Aggregator Advisor identifies molecules that are known form 
        aggregates, or may form aggregates in biochemical assays.  These can 
        inhibit proteins non-specifically, wasting the investigators time and 
        money.`,
    ...
    },
    {
      name: "Arthor Private",
      description:
        `The private Arthor databases protects molecules from being disclosed
    ...
    },
    {
      ...
      description:
        `Search commercially available building blocks (reagents) using 
    ...
    },
    {
      ...
      description:
        `The Chemistry Commons enumerates compounds that can be made in one or 
    ...
    },
    {
      name: "AWS",
      description:
        `ZINC is part of the AWS Open Data Sponsorship Program, for which we 
    ...
    },
    {
      ...
      description:
        `Commercially available covalent ligands are organized here by warhead
  ...
  const importantWebsites = [
    ...
    },
    {
      name: "DOCK",
      description:
        `DOCK takes small molecules and flies them into the binding site of a 
        3D protein model, sampling typically about a million poses, retaining 
        the best, which it uses to rank the database from best to worst. 
        There are two versions, conceptually similar but with very little code 
        in common: DOCK 6.12 and DOCK 3.8.5.`,
